 ...
 * Autoloader
 *
 * @package firstWpPluginUsingVuejs
 */
...
if (!function_exists('firstWpPluginUsingVuejsAutoload')) {
    /**
     * Plugin autoloader.
     *
     ...
     * @param $class
     */
    function firstWpPluginUsingVuejsAutoload($class)
    {
        // Do not load unless in plugin domain.
        $namespace = 'firstWpPluginUsingVuejs';
    ...
    spl_autoload_register('firstWpPluginUsingVuejsAutoload');
}
